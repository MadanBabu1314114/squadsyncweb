...
class CreateAndManageOrganizationRow extends StatelessWidget {
  const CreateAndManageOrganizationRow(
      {Key? key,
      required this.organizationName,
      required this.organizationType,
      required this.organizationId,
      required this.organizationPrimaryAdminEmail, required this.isSelected})
      : super(key: key);
        ...
        children: [
          ...
          Expanded(
              ...
              child: Container(
                ...
                height: 30,
                child: const Center(
                  child:  Icon(Icons.edit , color:   Color.fromARGB(255, 251, 138, 0),)
                ),
              )),
        ],
      ),
